// Another one smart — landing page components
...
function Header({ L, t, lang, onSetLang }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled || menuOpen ? "bg-[var(--surface)]/80 backdrop-blur-xl border-b border-[var(--border)] shadow-sm" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
          <a href="#" className="flex items-center gap-2.5 shrink-0 min-w-0">
            ...
            <span className="text-[14px] sm:text-[15px] font-bold tracking-tight text-[var(--fg)] whitespace-nowrap truncate">Another one smart</span>
          </a>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-0.5 rounded-full bg-[var(--surface-alt)] border border-[var(--border)] p-0.5 sm:mr-1" aria-label="Language">
              {["ru", "en"].map(l => (
                <button
                  key={l}
                  type="button"
            ...
            >
              <Icon path={menuOpen ? I.x : I.menu} size={22} strokeWidth="2.25" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div
        id="mobile-drawer"
        ref={drawerRef}
        className={`md:hidden overflow-hidden transition-all duration-200 ease-out border-t border-[var(--border)] bg-[var(--surface)]/95 backdrop-blur-xl ${menuOpen ? "max-h-[80vh] opacity-100" : "max-h-0 opacity-0 border-transparent"}`}
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col">
          {t.nav.map((l, i) => (
            <a
              ...
              onClick={closeDrawer}
              className="block px-2 py-3 text-base font-semibold text-[var(--fg-secondary)] hover:text-[var(--fg)] border-b border-[var(--border)] last:border-b-0 min-h-[44px]"
            >
              {l.label}
            </a>
          ))}
          <a
            href="#cta"
            onClick={closeDrawer}
            className="mt-5 inline-flex items-center justify-center w-full py-3.5 text-base font-semibold text-white rounded-full bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 transition-all shadow-md shadow-purple-500/25 min-h-[44px]"
          >
            {t.navCta}
          </a>
        </nav>
...
function Hero({ t, L }) {
  return (
    <section className="relative pt-24 sm:pt-28 pb-14 sm:pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[600px] max-w-[90vw] h-[600px] max-h-[90vw] bg-purple-300/30 rounded-full blur-3xl" />
        <div className="absolute top-20 right-1/4 w-[500px] max-w-[80vw] h-[500px] max-h-[80vw] bg-blue-300/25 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 left-1/3 w-[400px] max-w-[70vw] h-[400px] max-h-[70vw] bg-teal-200/25 rounded-full blur-3xl" />
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 sm:mt-7 text-base sm:text-xl text-[var(--fg-secondary)] max-w-2xl leading-relaxed">
            {t.hero.lead}
          </p>
          <div className="mt-7 sm:mt-9 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
            <a href="#cta" className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 text-base font-semibold text-white rounded-full bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 transition-all shadow-lg shadow-purple-500/30 hover:shadow-xl hover:-translate-y-0.5 min-h-[44px]">
              {t.hero.ctaPrimary}<Icon path={I.arrowRight} size={16} strokeWidth="2.5" style={{ marginLeft: 8 }} />
            </a>
            <a href="#format" className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 text-base font-semibold text-[var(--fg)] rounded-full border-2 border-[var(--border-strong)] hover:bg-[var(--surface-alt)] transition-all min-h-[44px]">
              {t.hero.ctaSecondary}
            </a>
          </div>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-24 grid grid-cols-12 gap-4 lg:gap-6">
          <div className="col-span-12 md:col-span-5 p-5 sm:p-6 lg:p-8 rounded-2xl bg-gradient-to-br from-purple-600 via-blue-600 to-teal-500 text-white shadow-xl shadow-purple-500/20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold leading-tight">{t.hero.h1pre}</div>
              <div className="mt-8 sm:mt-10 flex items-center gap-3 text-purple-100 text-sm font-medium">
                <Icon path={I.sliders} size={16} />
                Noise · Hype · Fragments
              </div>
            </div>
          </div>
          <div className="col-span-12 md:col-span-2 flex items-center justify-center py-2 md:py-4">
          ...
          <div className="col-span-12 md:col-span-5 p-5 sm:p-6 lg:p-8 rounded-2xl bg-[var(--surface)] border border-[var(--border)] shadow-lg">
...
function Audience({ t }) {
  ...
  return (
    <section className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {t.audience.groups.map((g, i) => (
            <div key={i} className="p-5 sm:p-6 rounded-2xl bg-[var(--surface)] border border-[var(--border)] hover:border-purple-200 hover:shadow-lg hover:shadow-purple-500/5 transition-all">
...
function Problem({ t }) {
  return (
    <section id="problem" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface-alt)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
          ...
          <p className="mt-5 text-base sm:text-lg text-[var(--fg-secondary)] max-w-2xl leading-relaxed">{t.problem.sub}</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {t.problem.cards.map((p, i) => (
            <div key={i} className="p-5 sm:p-6 lg:p-7 rounded-2xl bg-[var(--surface)] border border-[var(--border)]">
        ...
        <div className="mt-8 sm:mt-10 p-5 sm:p-6 lg:p-8 rounded-2xl border-l-0 bg-[var(--surface)] border border-[var(--border)] relative overflow-hidden">
          <div className="absolute top-0 left-0 bottom-0 w-1 bg-gradient-to-b from-purple-600 via-blue-500 to-teal-400" />
          <p className="text-base sm:text-lg lg:text-xl font-medium text-[var(--fg)] leading-relaxed italic max-w-4xl pl-4">
            {t.problem.quote}
          </p>
        </div>
      </div>
...
function Outcomes({ t }) {
  ...
  return (
    <section id="outcomes" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
          ...
          <p className="mt-5 text-base sm:text-lg text-[var(--fg-secondary)] max-w-2xl leading-relaxed">{t.outcomes.sub}</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {t.outcomes.items.map((it, i) => (
            <div key={i} className="group p-5 sm:p-6 lg:p-7 rounded-2xl bg-[var(--surface)] border border-[var(--border)] hover:border-transparent hover:shadow-xl hover:shadow-purple-500/10 transition-all">
...
function NotThis({ t }) {
  return (
    <section className="py-14 sm:py-20 lg:py-28 bg-[var(--surface-alt)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {t.notThis.items.map((it, i) => (
            <div key={i} className="p-5 sm:p-6 lg:p-7 rounded-2xl bg-[var(--surface)] border border-[var(--border)] flex gap-4 sm:gap-5">
...
function Format({ t }) {
  ...
  return (
    <section id="format" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
          ...
          <p className="mt-5 text-base sm:text-lg text-[var(--fg-secondary)] max-w-2xl leading-relaxed">{t.format.sub}</p>
        </div>

        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {/* Connecting line */}
        ...
        <div className="mt-10 sm:mt-14 p-5 sm:p-6 rounded-xl bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-500/10 dark:to-blue-500/10 border border-purple-100 dark:border-purple-500/20 flex items-start gap-4">
...
function About({ t }) {
  const a = t.about;
  return (
    <section id="about" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 sm:gap-4">
              {a.stats.map((s, i) => (
                <div key={i} className="p-3 sm:p-5 rounded-xl bg-[var(--surface-alt)] border border-[var(--border)]">
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent tracking-tight">{s.v}</div>
                  <div className="mt-1 text-[11px] sm:text-xs lg:text-sm text-[var(--fg-muted)] font-medium leading-tight">{s.l}</div>
                </div>
              ))}
            </div>
            ...
            <a href={a.ctaMoreHref} className="mt-8 inline-flex items-center justify-center px-6 py-3 text-sm font-semibold text-[var(--fg)] rounded-full border-2 border-[var(--border-strong)] hover:bg-[var(--surface-alt)] transition-all min-h-[44px]">
...
function Pricing({ t }) {
  return (
    <section id="pricing" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-10 sm:mb-14">
          ...
          <p className="mt-5 text-base sm:text-lg text-[var(--fg-secondary)] max-w-2xl leading-relaxed">{t.pricing.sub}</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {t.pricing.plans.map((p, i) => (
            <div key={i} className={`relative flex flex-col rounded-2xl p-6 sm:p-7 lg:p-8 transition-all ${p.highlighted ? "bg-gradient-to-b from-purple-600 via-blue-600 to-blue-700 text-white shadow-xl shadow-purple-500/25 lg:-translate-y-4 ring-2 ring-purple-400/40 md:col-span-2 lg:col-span-1" : "bg-[var(--surface)] border border-[var(--border)] hover:border-purple-200 hover:shadow-lg"}`}>
              {p.badge && (
  ...
  return (
    <section className="py-14 sm:py-20 lg:py-28 bg-[var(--surface-alt)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[var(--fg)] leading-tight mb-8 sm:mb-10">
          {t.notFor.title}
        </h2>
        <div className="space-y-3">
          {t.notFor.items.map((it, i) => (
            <div key={i} className="p-4 sm:p-5 rounded-xl bg-[var(--surface)] border border-[var(--border)] flex items-center gap-3 sm:gap-4">
...
function FAQ({ t }) {
  ...
  return (
    <section id="faq" className="py-14 sm:py-20 lg:py-28 bg-[var(--surface)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
...
function FinalCTA({ t }) {
  return (
    <section id="cta" className="py-16 sm:py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
          <a href="#" className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 text-base font-bold text-purple-700 bg-white rounded-full hover:bg-purple-50 shadow-xl hover:-translate-y-0.5 transition-all min-h-[44px]">
            {t.cta.primary}<Icon path={I.arrowRight} size={16} strokeWidth="2.5" style={{ marginLeft: 8 }} />
          </a>
          <a href="#" className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 text-base font-semibold text-white rounded-full border-2 border-white/30 hover:border-white/50 hover:bg-white/10 transition-all min-h-[44px]">
            {t.cta.secondary}
          </a>
        </div>
